...
dependencies {
    ...
    implementation(group = "com.objt", name = "objt.supervisor-core")
    ...
    // objt.driver.proximity (for VisitorEntryWizard)
...
runTask.args = listOf("supervisor.properties", "objt/app/supervisor/supervisor.xml", "REMOTE")
