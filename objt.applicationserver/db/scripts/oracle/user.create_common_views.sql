...
CREATE OR REPLACE VIEW DCEREPORT_EMPLOYEES
AS
SELECT /*+ FIRST_ROWS(30) */ employee.OID OID,
       employee.NAME NAME,
...
FROM OBJT_EMPLOYEE employee
/

-- EMPLOYEE GROUPS --

CREATE OR REPLACE VIEW DCEREPORT_EMPLOYEE_GROUPS
AS
SELECT /*+ FIRST_ROWS(30) */ employeegroup.OID OID,
       ...
       CAST(GREATEST(employeegroup.DTSUPDATE, employee.DTSUPDATE) AS DATE) DTSUPDATE,
       employeegroup.DTSUPDATE AS DTSUPDATE_1,
       employee.DTSUPDATE AS DTSUPDATE_2
FROM OBJT_EMPLOYEEGROUP employeegroup,
     OBJT_RESOURCELINK group_employee_link,
...
CREATE OR REPLACE VIEW DCEREPORT_CUSTOMERS
AS
SELECT /*+ FIRST_ROWS(30) */ customer.OID OID,
       customer.NAME NAME,
...
FROM  OBJT_CUSTOMER customer
/

-- SUPPLIERS --

CREATE OR REPLACE VIEW DCEREPORT_SUPPLIERS
AS
SELECT /*+ FIRST_ROWS(30) */ supplier.OID OID,
       supplier.NAME NAME,
...
FROM  OBJT_SUPPLIER supplier
/

-- CARRIERS --

CREATE OR REPLACE VIEW DCEREPORT_CARRIERS
AS
SELECT /*+ FIRST_ROWS(30) */ carrier.OID OID,
       carrier.NAME NAME,
...
FROM  OBJT_CARRIER carrier
/

-- ITEMS --

CREATE OR REPLACE VIEW DCEREPORT_ITEMS
AS
SELECT /*+ FIRST_ROWS(30) */ item.OID OID,
       uom.OID UOM_OID,
       item.NAME NAME,
       ...
       item.ABCSKU ABCSKU,
       item.ABCLPN ABCLPN,
       CASE WHEN (BITAND(item.LOTCONTROL,1) = 1) THEN 'T' ELSE 'F' END AS LOTCONTROLLED,
       CASE WHEN (BITAND(item.LOTCONTROL, 2) = 2) THEN 'T' ELSE 'F' END AS SUBLOTCONTROLLED,
       CASE WHEN (BITAND(item.LOTCONTROL, 4) = 4) THEN 'T' ELSE 'F' END AS SERIALCONTROLLED,
...
FROM OBJT_ITEM item,
     OBJT_ITEMUOMLINK item_uom_link,
     OBJT_UOM uom
...
-- ITEMPARAMETERS --
CREATE OR REPLACE VIEW DCEREPORT_ITEMPARAMETERS
AS
SELECT /*+ FIRST_ROWS(30) */ item.OID ITEM_OID,
	   ...
	   itemextension.DTSUPDATE DTSUPDATE
FROM OBJT_ITEM item LEFT JOIN OBJT_ITEMEXTENSION itemextension ON item.EXTENSIONOID = itemextension.OID
/

-- UOMS --

CREATE OR REPLACE VIEW DCEREPORT_UOMS
AS
SELECT /*+ FIRST_ROWS(30) */ uom.OID OID,
       uom.NAME NAME,
       uom.SYMBOL SYMBOL,
       ...
       (SELECT dimension.NAME FROM OBJT_DIMENSIONUOMLINK uom_dimension_link,
                                   OBJT_DIMENSION dimension
...
CREATE OR REPLACE VIEW DCEREPORT_LOTS
AS
SELECT /*+ FIRST_ROWS(30) */ lot.OID OID,
...
-- LOTPARAMETERS --
CREATE OR REPLACE VIEW DCEREPORT_LOTPARAMETERS
AS
SELECT /*+ FIRST_ROWS(30) */ lot.OID LOT_OID,
	   ...
	   lotextension.DTSUPDATE DTSUPDATE
FROM OBJT_LOT lot LEFT JOIN OBJT_ITEMEXTENSION lotextension ON lot.EXTENSIONOID = lotextension.OID
/

-- QCSTATUSES --

CREATE OR REPLACE VIEW DCEREPORT_QCSTATUSES
AS
SELECT /*+ FIRST_ROWS(30) */ qcstatus.OID OID,
       qcstatus.NAME NAME,
...
FROM OBJT_QUALITYCONTROLSTATUS qcstatus
/

-- CONTAINER TYPES --

CREATE OR REPLACE VIEW DCEREPORT_CONTAINER_TYPES
AS
SELECT /*+ FIRST_ROWS(30) */ container.OID OID,
       container.NAME NAME,
       container.DESCRIPTION DESCRIPTION,
       container.ID ID,
       uom.SYMBOL UOM,
       container.ISASSETCONTROLLED ISASSETCONTROLLED,
       CASE WHEN (BITAND(container.LOTCONTROL, 4) = 4) THEN 'T' ELSE 'F' END AS SERIALCONTROLLED,
...
FROM  OBJT_CONTAINER container,
      OBJT_ITEMUOMLINK itemuomlink,
      OBJT_UOM uom
...
CREATE OR REPLACE VIEW DCEREPORT_CONTAINERS
AS
SELECT /*+ FIRST_ROWS(30) */ csitq.OID OID,
...
FROM OBJT_CONTAINERSTORAGEITEMQTY csitq
        LEFT JOIN OBJT_LOT containerlot ON csitq.ITEMOID = containerlot.OID
WHERE (csitq.CLASSOID = 9000000000000095836 OR csitq.CLASSOID = 9000000000000095841)
/

-- DEVICES --

CREATE OR REPLACE VIEW DCEREPORT_DEVICES
AS
SELECT /*+ FIRST_ROWS(30) */ device.OID OID,
...
FROM OBJT_DEVICE device
/

-- PROCESSRESOURCES --
CREATE OR REPLACE VIEW DCEREPORT_PROCESSRESOURCES
AS
SELECT /*+ FIRST_ROWS(30) */ processresource.OID OID,
       ...
       CASE WHEN (processresource.CLASSOID = 9000000000000010923) THEN 'MACHINE'
       	    WHEN (processresource.CLASSOID = 9000000000000037041) THEN 'WORKCENTER' END AS TYPE,
...
FROM OBJT_PROCESSUNIT processresource
WHERE processresource.CLASSOID = 9000000000000010923 OR processresource.CLASSOID = 9000000000000037041
/

-- MACHINES --

CREATE OR REPLACE VIEW DCEREPORT_MACHINES
AS
SELECT /*+ FIRST_ROWS(30) */ machine.OID OID,
       machine.NAME NAME,
...
FROM OBJT_PROCESSUNIT machine
WHERE machine.CLASSOID = 9000000000000010923
/

-- WORKCENTERS --

CREATE OR REPLACE VIEW DCEREPORT_WORKCENTERS
AS
SELECT /*+ FIRST_ROWS(30) */ workcenter.OID OID,
...
WHERE workcenter.CLASSOID = 9000000000000037041
/

-- SHIFT TYPES --

CREATE OR REPLACE VIEW DCEREPORT_SHIFT_TYPES
AS
SELECT /*+ FIRST_ROWS(30) */ shift.OID OID,
       shift.NAME NAME,
       shift.DESCRIPTION DESCRIPTION,
       shift.DTSVALIDFROM DTSVALIDFROM,
       shift.DTSVALIDUNTIL DTSVALIDUNTIL,
       shift.DTSUPDATE DTSUPDATE
FROM  OBJT_SHIFT shift
WHERE shift.TOID = -1
/

-- SKILLS --

CREATE OR REPLACE VIEW DCEREPORT_SKILLS
AS
SELECT /*+ FIRST_ROWS(30) */ skill.OID OID,
       skill.NAME NAME,
       skill.DESCRIPTION DESCRIPTION,
       skill.DTSVALIDFROM DTSVALIDFROM,
       skill.DTSVALIDUNTIL DTSVALIDUNTIL,
       skill.DTSUPDATE DTSUPDATE
FROM OBJT_ROLE skill
WHERE skill.CLASSOID = 9000000000000025222
/

-- COMMENTS --
CREATE OR REPLACE VIEW DCEREPORT_COMMENTS
AS
SELECT /*+ FIRST_ROWS(30) */ comments.OID OID,
       comments.OWNEROID OWNER_OID,
       comments.EMPLOYEEOID EMPLOYEE_OID,
       comments.COMMENTS COMMENTS,
       comments.DTS DTS,
       comments.DTSUPDATE DTSUPDATE
FROM OBJT_COMMENT comments
/

-- DEPARTMENTS --
CREATE OR REPLACE VIEW DCEREPORT_DEPARTMENTS
AS
SELECT /*+ FIRST_ROWS(30) */ department.OID OID,
...
CREATE OR REPLACE VIEW DCEREPORT_DEPT_EMPLOYEES
AS
SELECT /*+ FIRST_ROWS(30) */ department.OID OID,
       department.NAME NAME,
       department.DESCRIPTION DESCRIPTION,
