...
dependencies {
    ...
    // toverify te: dependency still needed here?
    runtimeOnly(group = "com.objt", name = "objt.meta.tools")  // for datawarehousetablegenerator
...
runTask.args = listOf("datawarehouse.properties", "objt/app/datawarehouseserver/datawarehouse.xml")
...
distributions {
    main {
        contents {
            with(distFiles, environmentConfigFiles, defaultConfigFiles, serviceWrapperFiles, nativeLibs, databaseScripts)
