...
dependencies {
    ...
    implementation(group = "com.objt", name = "objt.configurator-core")
    ...
    // objt.driver.proximity (for AccessBadgeWizard)
    runtimeOnly(group = "com.objt", name = "objt.driver.proximity")
    ...
    // serialio (e.g. for defining access badges using attached readers)
...
application{
    mainClass.set("dce.pd.frame.configurator.Configurator")
    applicationDefaultJvmArgs = listOf("-Xms128M", "-Xmx512M", "-Dsun.java2d.d3d=false", "-XX:+UseG1GC")
}

val runTask : JavaExec = tasks.getByPath("run") as JavaExec
runTask.args = listOf("configurator.properties", "objt/app/configurator/configurator.xml", "REMOTE")
