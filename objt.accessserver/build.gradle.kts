...
dependencies {
    ...
    implementation(group = "com.objt", name = "objt.accessserver-core")
...
runTask.args = listOf("accessserver.properties", "objt/app/accessserver/accessserver.xml")
...
// include the wrapper files for the deployment
